  ...
  return (
    <main className="w-full flex flex-col px-2 my-6">
      ...
      <p className="my-1 leading-7">
        ...
        Tracker app as a Freemium app. This SERVICE is provided at no cost and is intended for use as is.
      </p>
      <p className="my-1 leading-7">
      ...
      <p className="my-1 leading-7">
        ...
        accessible at Subs Tracker unless otherwise defined in this Privacy Policy.
      </p>
      ...
      <p className="my-1 leading-7">Link to the privacy policy of third-party service providers used by the</p>
      ...
      <p className="my-1 leading-7">I may employ third-party companies and individuals due to the following reasons:</p>
