...
export default function CardSkeleton({ className = '' }: { className?: string }) {
  return (
    <div
      className={`flex h-[72px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring justify-between bg-card-background p-3 px-4 rounded-xl border border-input ${className}`}
    >
